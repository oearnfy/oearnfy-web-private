...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Save user data to session storage temporarily
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              >
                ...
                >
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 filter drop-shadow-glow">
                    OEARNFY
                  </span>
                </motion.h1>
                <h2 className="text-2xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300">
                  Create Account
                </h2>
                <p className="text-gray-400 text-lg">
                  Join us to start earning today!
                </p>
              </motion.div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FaEnvelope className="text-white/60 group-focus-within:text-blue-400 transition-colors" />
                </div>
                <input
                  type="email"
                  name="email"
              ...
              >
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <RiLockPasswordLine className="text-xl text-white/60 group-focus-within:text-blue-400 transition-colors" />
                </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-white/70">Uppercase letter</span>
                      </div>
                      <div className="flex items-center space-x-1">
                        {/[a-z]/.test(formData.password) ? (
                          <FaCheckCircle className="text-green-400" />
                        ...
                        <span className="text-white/70">Lowercase letter</span>
                      </div>
                      <div className="flex items-center space-x-1">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-white/70">Special character</span>
                      </div>
                    </div>
